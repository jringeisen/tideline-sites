    ...
    <div>
            ...
            <div class="mx-auto max-w-7xl px-6 pt-36 pb-20 sm:pt-44 lg:px-8 lg:pt-52">
                ...
                <div class="max-w-3xl">
                    ...
                    <dl class="mt-10 grid max-w-md grid-cols-2 gap-6">
                        <div>
                            <dt class="text-xs font-medium tracking-wider text-white/60 uppercase">Where we build</dt>
                            <dd class="mt-1 font-serif text-4xl">Nationwide</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-medium tracking-wider text-white/60 uppercase">Local SEO markets</dt>
                            <dd class="mt-1 font-serif text-4xl">{{ cities.length }}+ towns</dd>
                        </div>
                    </dl>
                </div>
            </div>
        ...
        <section class="bg-[var(--color-cream)] py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Local markets</p>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid items-start gap-16 lg:grid-cols-12">
                    <div class="lg:col-span-5">
                        <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Gulf Coast, Florida</p>
                        <h2 class="mt-3 font-serif text-3xl font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-4xl">
                    ...
                    <div class="lg:col-span-7">
                        <div class="relative rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[var(--color-sand-300)]/60 sm:p-8">
                            <div class="mb-6 flex items-center justify-between border-b border-[var(--color-sand-300)]/60 pb-4">
                                <span class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Florida's Gulf Coast</span>
                                <span class="font-serif text-sm font-bold tracking-wide text-[var(--color-deep-teal)] uppercase">{{ cities.length }} towns</span>
                            </div>

                            <ul class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm sm:grid-cols-3">
                                <li v-for="city in cities" :key="city" class="flex items-center gap-2 text-slate-700">
        ...
        <section class="relative isolate overflow-hidden bg-[var(--color-navy-deep)] py-20 text-white sm:py-28">
            ...
            <div class="mx-auto max-w-3xl px-6 text-center lg:px-8">
                <h2 class="font-serif text-3xl font-bold tracking-tight uppercase sm:text-4xl">Ready to win in your town?</h2>
