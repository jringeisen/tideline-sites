...
<template>
    ...
    <div class="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
        <header>
            ...
            <p class="mt-3 max-w-2xl text-sm leading-relaxed text-slate-600 dark:text-white/70">
        ...
        <div class="mt-10 grid gap-6 sm:grid-cols-2">
            <article
                v-if="isAdmin"
                class="rounded-3xl bg-white p-7 ring-1 ring-[var(--color-sand-300)]/60 shadow-[0_1px_0_rgba(11,42,46,0.04)] sm:p-8 dark:bg-white/[0.04] dark:ring-white/10"
            >
                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--color-emerald-700)]">
                    Blog
                </p>
                <h2 class="mt-2 font-serif text-2xl text-[var(--color-deep-teal)]">
                    Write something new.
                </h2>
                <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-white/70">
                    Draft a post, schedule it, or publish on the spot. Categories and tags help readers find their way.
                </p>
            ...
            >
                ...
                <p class="mt-3 text-sm leading-relaxed text-slate-600 dark:text-white/70">
                    Update your name, change your password, manage two-factor authentication and passkeys.
                </p>
                <div class="mt-6">
                    <Button as-child variant="ghost">
