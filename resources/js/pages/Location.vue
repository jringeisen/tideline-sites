...
const services = computed<Array<[string, string]>>(() => [
    ['Web Design', `Fast, beautiful sites built for ${props.location.name} customers.`],
    ['SEO Optimization', `Local SEO that wins searches in ${props.location.name} and nearby towns.`],
    ...
    <div>
            ...
            <div class="mx-auto max-w-7xl px-6 pt-36 pb-20 sm:pt-44 lg:px-8 lg:pt-52">
                ...
                <div class="max-w-3xl">
                    ...
                    <h1 class="mt-6 font-serif text-6xl leading-[0.95] font-bold tracking-tight uppercase sm:text-7xl lg:text-8xl">
                        {{ location.name }}
                        <span class="block text-[var(--color-red)]"><span v-html="location.tagline" />.</span>
                    </h1>
                    <p class="mt-6 max-w-xl text-2xl leading-snug text-white/90 sm:text-3xl" v-html="location.hero_subhead" />
        ...
        <section class="bg-[var(--color-cream)] py-20 sm:py-28">
            <div class="mx-auto max-w-3xl px-6 lg:px-8">
                <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Why {{ location.name }}</p>
        ...
        <section class="bg-[var(--color-sand-100)] py-20 sm:py-28">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Who we serve</p>
                ...
                <div class="mx-auto mt-14 grid max-w-5xl gap-6 sm:grid-cols-2">
                    ...
                    >
                        <h3 class="font-serif text-xl text-[var(--color-deep-teal)]" v-html="segment[0]" />
                        <p class="mt-2 text-sm leading-relaxed text-slate-600" v-html="segment[1]" />
                    </article>
                </div>
            </div>
        </section>
        ...
        <section class="bg-[var(--color-cream)] py-20 sm:py-28">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="mx-auto mt-14 grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                        <h3 class="font-serif text-lg text-[var(--color-deep-teal)]">{{ service[0] }}</h3>
                        <p class="mt-2 text-sm leading-relaxed text-slate-600">{{ service[1] }}</p>
                    </article>
                </div>

                <p class="mt-10 text-center text-sm text-slate-600">
                    <Link href="/#services" class="font-medium text-[var(--color-emerald-700)] underline-offset-4 hover:underline">See all four services →</Link>
                </p>
            </div>
        </section>
        ...
        <section v-if="nearby.length" class="bg-[var(--color-sand-100)] py-16">
            <div class="mx-auto max-w-3xl px-6 text-center lg:px-8">
                <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">We also serve</p>
                <h2 class="mt-3 font-serif text-2xl font-bold text-[var(--color-deep-teal)] uppercase">Nearby Gulf Coast towns</h2>
