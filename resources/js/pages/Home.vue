...
const initialVeteran = (() => {
    ...
    return new URLSearchParams(page.url.slice(queryIndex)).get('veteran') === '1';
})();
...
<template>
    <div>
        ...
        <section class="relative isolate overflow-hidden bg-[var(--color-navy-deep)] text-white">
            <div class="absolute inset-0 -z-10" style="background: linear-gradient(180deg, #1e2e44 0%, #243650 55%, #1a2840 100%)" />
            <img
                ...
                fetchpriority="high"
            />
            <div class="absolute inset-0 -z-10 bg-gradient-to-r from-[var(--color-navy-deep)]/95 via-[var(--color-navy-deep)]/70 to-[var(--color-navy-deep)]/40" />
            ...
            <div class="mx-auto max-w-7xl px-6 pt-36 pb-24 sm:pt-44 sm:pb-32 lg:px-8 lg:pt-52 lg:pb-40">
                <div class="max-w-3xl">
                    <span class="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold tracking-[0.18em] text-white/90 uppercase backdrop-blur">
                        <span class="h-1.5 w-1.5 rounded-full bg-[var(--color-red)]" />
                        Veteran-owned · Built in the USA
                    </span>
                    <h1 class="mt-6 font-serif text-6xl leading-[0.95] font-bold tracking-tight uppercase sm:text-7xl lg:text-8xl">
                        Built in America.
                    ...
                    <dl
                        ...
                        :class="features.businessesLaunched ? 'sm:grid-cols-3' : ''"
                    >
                        <div v-if="features.businessesLaunched">
                            <dt class="text-xs tracking-wider text-white/80 uppercase">Businesses launched</dt>
                            <dd class="mt-1 flex items-baseline gap-1 font-serif text-2xl text-white">
                                30<span class="text-base text-white/80">+</span>
                            </dd>
                        </div>
                        <div>
                            <dt class="text-xs tracking-wider text-white/80 uppercase">Average launch</dt>
                            <dd class="mt-1 font-serif text-2xl text-white">1&ndash;2 weeks</dd>
                        </div>
                        <div>
                            <dt class="text-xs tracking-wider text-white/80 uppercase">Where it's built</dt>
        ...
        <!-- ───────── Testimonials ───────── -->
        <section v-if="features.testimonials" aria-label="What local owners are saying" class="bg-[var(--color-cream)] pt-20 sm:pt-24">
            <div class="mx-auto max-w-6xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Loved by local owners</p>
                    <h2 class="mt-3 font-serif text-3xl tracking-tight text-[var(--color-deep-teal)] sm:text-4xl">
                        Real businesses. Real results.
                    </h2>
                </div>

                <figure class="relative mx-auto mt-12 max-w-3xl overflow-hidden rounded-3xl bg-white p-8 shadow-[0_1px_0_rgba(11,42,46,0.04)] ring-1 ring-[var(--color-sand-300)]/60 sm:p-12 dark:bg-white/[0.04] dark:ring-white/10">
                    ...
                    <figcaption class="relative mt-6 flex items-center gap-4">
                        <span class="grid h-12 w-12 flex-none place-items-center rounded-full bg-[var(--color-emerald-50)] font-serif text-lg text-[var(--color-emerald-700)] ring-1 ring-[var(--color-emerald-600)]/15 dark:bg-white/10 dark:text-[var(--color-emerald-200)] dark:ring-white/15">SK</span>
                        <div>
                ...
                <div class="mx-auto mt-6 grid max-w-5xl gap-6 sm:grid-cols-2">
                    <figure class="rounded-2xl bg-white p-6 shadow-[0_1px_0_rgba(11,42,46,0.04)] ring-1 ring-[var(--color-sand-300)]/60 dark:bg-white/[0.04] dark:ring-white/10">
                        ...
                        <figcaption class="mt-4 flex items-center gap-3">
                            <span class="grid h-10 w-10 flex-none place-items-center rounded-full bg-[var(--color-emerald-50)] font-serif text-sm text-[var(--color-emerald-700)] ring-1 ring-[var(--color-emerald-600)]/15 dark:bg-white/10 dark:text-[var(--color-emerald-200)] dark:ring-white/15">MR</span>
                            <div>
                    ...
                    <figure class="rounded-2xl bg-white p-6 shadow-[0_1px_0_rgba(11,42,46,0.04)] ring-1 ring-[var(--color-sand-300)]/60 dark:bg-white/[0.04] dark:ring-white/10">
                        ...
                        <figcaption class="mt-4 flex items-center gap-3">
                            <span class="grid h-10 w-10 flex-none place-items-center rounded-full bg-[var(--color-emerald-50)] font-serif text-sm text-[var(--color-emerald-700)] ring-1 ring-[var(--color-emerald-600)]/15 dark:bg-white/10 dark:text-[var(--color-emerald-200)] dark:ring-white/15">JT</span>
                            <div>
                ...
                <p class="mt-8 text-center text-xs text-slate-500">
                    Why design matters:
                    <a href="https://dl.acm.org/doi/10.1145/997078.997097" target="_blank" rel="noopener" class="underline underline-offset-4 hover:text-[var(--color-emerald-700)]">46% of people judge a site's credibility on visual design alone</a>
                    (Stanford, Fogg et al.).
                </p>
            </div>
        </section>
        ...
        <section id="services" class="bg-[var(--color-cream)] py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">What we do</p>
                    <h2 class="mt-3 font-serif text-4xl font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-5xl">
                ...
                <div class="mx-auto mt-16 grid max-w-6xl gap-6 lg:grid-cols-2">
                    ...
                    >
                        <span aria-hidden="true" class="pointer-events-none absolute -top-12 -right-12 h-40 w-40 rounded-full bg-[var(--color-navy)]/5 transition duration-300 group-hover:scale-110 dark:bg-white/[0.04]" />
                        ...
                        <p class="relative mt-6 text-xs font-medium tracking-[0.18em] text-[var(--color-red)] uppercase">Included in every plan</p>
                    </article>
                </div>

                <div class="mx-auto mt-6 max-w-6xl">
                    <div class="rounded-3xl border border-dashed border-[var(--color-red)]/30 bg-[var(--color-navy)]/[0.04] p-6 sm:p-8 dark:border-white/10 dark:bg-white/[0.03]">
                        <div class="flex flex-col gap-2 sm:flex-row sm:items-baseline sm:justify-between">
                            ...
                            <a href="#pricing" class="inline-flex items-center gap-1 text-xs font-semibold tracking-[0.18em] text-[var(--color-emerald-700)] uppercase hover:text-[var(--color-emerald-800)] focus-visible:rounded focus-visible:ring-2 focus-visible:ring-[var(--color-emerald-600)]/50 focus-visible:outline-none">
                                See Growth plan
        ...
        <section id="process" class="bg-[var(--color-sand-100)] py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">How it works</p>
                    <h2 class="mt-3 font-serif text-4xl font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-5xl">
                ...
                <div class="relative mx-auto mt-16 max-w-6xl">
                    <span aria-hidden="true" class="absolute top-5 left-5 hidden h-px w-[calc(100%-2.5rem)] bg-gradient-to-r from-[var(--color-emerald-600)]/30 via-[var(--color-emerald-600)]/30 to-transparent lg:block" />
                    <span aria-hidden="true" class="absolute top-0 bottom-0 left-5 w-px bg-[var(--color-emerald-600)]/20 lg:hidden" />

                    <ol class="lg:grid lg:grid-cols-4 lg:gap-8">
                        <li v-for="[num, title, duration, copy] in processSteps" :key="num" class="relative flex gap-5 pb-10 last:pb-0 lg:flex-col lg:gap-0 lg:pb-0">
                            ...
                            <div class="lg:mt-6">
                                <p class="text-xs font-medium tracking-[0.18em] text-[var(--color-red)] uppercase">{{ duration }}</p>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid items-start gap-12 lg:grid-cols-12">
                    <div class="lg:col-span-5">
                        <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">How we build</p>
                        ...
                        <p class="mt-8">
                            <Link href="/contact" class="inline-flex items-center gap-2 text-sm font-semibold text-[var(--color-emerald-700)] hover:text-[var(--color-emerald-800)]">
                    ...
                    <div class="lg:col-span-7">
                        <div class="rounded-3xl bg-white p-8 shadow-[0_1px_0_rgba(11,42,46,0.04)] ring-1 ring-[var(--color-sand-300)]/60 sm:p-10 dark:bg-white/[0.04] dark:ring-white/10">
                            <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">What we can build</p>
                            <ul class="mt-6 grid gap-x-6 gap-y-4 text-sm text-slate-700 sm:grid-cols-2">
                                <li v-for="capability in buildCapabilities" :key="capability" class="flex gap-3">
                                    <CheckIcon color="emerald" />{{ capability }}
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section id="work" class="bg-[var(--color-sand-100)] py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Recent work</p>
                    <h2 class="mt-3 font-serif text-4xl font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-5xl">
                ...
                <div class="mx-auto mt-16 grid max-w-6xl gap-8 lg:grid-cols-2">
                    ...
                    >
                        <div class="border-b border-[var(--color-sand-300)]/60 bg-[var(--color-cream)] px-4 py-3 dark:border-white/10 dark:bg-white/[0.03]">
                        ...
                        <div class="flex flex-1 flex-col gap-4 p-8">
                            <div>
                                <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">{{ project.tagline }}</p>
                            ...
                            <ul class="flex flex-wrap gap-2 text-xs">
                                <li v-for="tag in project.tags" :key="tag" class="rounded-full bg-[var(--color-navy)]/[0.06] px-2.5 py-1 font-medium text-[var(--color-navy)] ring-1 ring-[var(--color-navy)]/15 dark:bg-white/10 dark:text-white dark:ring-white/15">{{ tag }}</li>
                            </ul>
        ...
        <section class="bg-[var(--color-cream)] py-20 sm:py-28">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid items-center gap-12 lg:grid-cols-12">
                    ...
                    <div class="lg:col-span-7">
                        <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Meet the team</p>
                        <h2 class="mt-3 font-serif text-3xl leading-tight font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-4xl">
                            Family &amp; veteran owned, <span class="text-[var(--color-red)] normal-case">built in America</span>.
                        </h2>
                        <p class="mt-5 text-lg leading-relaxed text-slate-700">
                        ...
                        <p class="mt-8">
                            <Link href="/about" class="inline-flex items-center gap-2 text-sm font-semibold text-[var(--color-emerald-700)] hover:text-[var(--color-emerald-800)]">
                                Read our story
                                <svg class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M3 10a.75.75 0 01.75-.75h10.638L10.23 5.29a.75.75 0 111.04-1.08l5.5 5.25a.75.75 0 010 1.08l-5.5 5.25a.75.75 0 11-1.04-1.08l4.158-3.96H3.75A.75.75 0 013 10z" clip-rule="evenodd" />
                                </svg>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid items-center gap-12 lg:grid-cols-12">
                    <div class="lg:col-span-6">
                        <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Made in America</p>
                        <h2 class="mt-3 font-serif text-3xl leading-tight font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-4xl">
                        ...
                        <dl class="mt-6 grid grid-cols-2 gap-6">
                            <div>
                                <dt class="text-xs font-medium tracking-wider text-slate-500 uppercase">Where we build</dt>
                                <dd class="mt-1 font-serif text-3xl text-[var(--color-deep-teal)]">100% USA</dd>
                            </div>
                            <div>
                                <dt class="text-xs font-medium tracking-wider text-slate-500 uppercase">Owners served</dt>
                                <dd class="mt-1 font-serif text-3xl text-[var(--color-deep-teal)]">Nationwide</dd>
                            </div>
                        </dl>
                        <Link href="/contact" class="mt-6 inline-flex items-center text-sm font-semibold tracking-wide text-[var(--color-emerald-700)] uppercase hover:text-[var(--color-emerald-800)]">
                            Start your project
                    ...
                    <div class="lg:col-span-6">
                        <div class="relative isolate overflow-hidden rounded-3xl bg-[var(--color-navy)] p-10 text-white shadow-xl ring-1 ring-black/5 sm:p-12">
                            <img src="/american-flag.webp" alt="" width="1729" height="910" class="absolute inset-0 -z-10 h-full w-full object-cover opacity-25 mix-blend-luminosity" loading="lazy" />
                            <div class="absolute inset-0 -z-10 bg-gradient-to-br from-[var(--color-navy)]/80 via-[var(--color-navy)]/65 to-[var(--color-navy-deep)]/85" />
                            <p class="relative font-serif text-xs tracking-[0.22em] text-white/70 uppercase">Est. in the USA</p>
                            <p class="relative mt-3 font-serif text-4xl leading-[0.95] font-bold uppercase sm:text-5xl">
                            ...
                            <div class="relative mt-6 h-1 w-16 bg-[var(--color-red)]" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="pricing" class="relative bg-[var(--color-deep-teal)] py-24 text-white sm:py-32">
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-emerald-200)] uppercase">Pricing</p>
                    <h2 class="mt-3 font-serif text-4xl font-bold tracking-tight uppercase sm:text-5xl">Pricing that fits how you work.</h2>
                    <p class="mt-3 font-body text-2xl text-[var(--color-sand-200)]/90 italic">Monthly plans or a one-time build, no contracts.</p>
                ...
                <div class="mx-auto mt-10 flex max-w-md flex-col items-center gap-3 text-center">
                    ...
                    >
                        <span class="inline-flex h-6 w-11 flex-none items-center rounded-full p-0.5 transition-colors duration-200" :class="veteran ? 'bg-[var(--color-red)]' : 'bg-white/20'">
                            <span class="h-5 w-5 rounded-full bg-white shadow transition-transform duration-200" :class="veteran ? 'translate-x-5' : ''" />
                        </span>
                        Veteran pricing
                        <span class="rounded-full bg-[var(--color-red)] px-2 py-0.5 text-xs font-bold tracking-wide text-white uppercase">20% off</span>
                    </button>
                    <p v-show="veteran" class="text-sm text-[var(--color-emerald-200)]">
                        Veteran discount applied. Thank you for your service. 🇺🇸
                    </p>
                </div>

                <div class="mx-auto mt-16 grid max-w-6xl gap-6 sm:mt-20 lg:grid-cols-3">
                    <!-- Essential -->
                    <article class="flex flex-col rounded-3xl bg-white/[0.04] p-8 ring-1 ring-white/15 backdrop-blur">
                        ...
                        <ul class="mt-8 space-y-3 text-sm text-white/85">
                            <li class="flex gap-3"><CheckIcon />Custom web design</li>
                            <li class="flex gap-3"><CheckIcon />Mobile-optimized & fast</li>
                            <li class="flex gap-3"><CheckIcon />On-page SEO setup</li>
                            <li class="flex gap-3"><CheckIcon />Local listings (Google, Bing, Apple)</li>
                            <li class="flex gap-3"><CheckIcon />Google Search Console setup</li>
                            <li class="flex gap-3"><CheckIcon />Monthly SEO optimization</li>
                            <li class="flex gap-3"><CheckIcon />Hosting, SSL, backups</li>
                        </ul>
                        <a
                    ...
                    <article class="keep-light relative z-10 flex flex-col rounded-3xl bg-white p-8 text-[var(--color-deep-teal)] shadow-2xl shadow-black/40 ring-1 ring-white/30 lg:-my-6 lg:scale-105 lg:p-10">
                        <span class="absolute -top-4 left-1/2 inline-flex -translate-x-1/2 items-center gap-1.5 rounded-full bg-[var(--color-emerald-600)] px-4 py-1.5 text-xs font-semibold tracking-[0.14em] text-white uppercase shadow-lg shadow-black/30 ring-2 ring-white">
                            <svg class="h-3 w-3" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        <ul class="mt-8 space-y-3 text-sm text-slate-700">
                            <li class="flex gap-3"><CheckIcon color="emerald" />Everything in Essential</li>
                            <li class="flex gap-3"><CheckIcon color="emerald" />2 original blog posts / month</li>
                            <li class="flex gap-3"><CheckIcon color="emerald" />Weekly customer newsletter</li>
                            <li class="flex gap-3"><CheckIcon color="emerald" />Google Analytics</li>
                            <li class="flex gap-3"><CheckIcon color="emerald" />Priority support</li>
                            <li class="flex gap-3"><CheckIcon color="emerald" />Quarterly performance report</li>
                        </ul>
                        <a
                    ...
                    <article class="flex flex-col rounded-3xl bg-white/[0.04] p-8 ring-1 ring-white/15 backdrop-blur">
                        ...
                        <ul class="mt-8 space-y-3 text-sm text-white/85">
                            <li class="flex gap-3"><CheckIcon />Everything in Essential</li>
                            <li class="flex gap-3"><CheckIcon />Google Analytics</li>
                            <li class="flex gap-3"><CheckIcon />One-time build, then it's yours</li>
                            <li class="flex gap-3"><CheckIcon />Hosting, SSL, backups &amp; security updates</li>
                        </ul>
                        <a
                            :href="contactHref()"
                            class="mt-10 inline-flex items-center justify-center rounded-full border border-white/30 px-6 py-3 text-sm font-semibold tracking-wide text-white uppercase transition duration-200 ease-out hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-deep-teal)] focus-visible:outline-none"
                ...
                <p class="mt-10 text-center text-sm text-white/60">
                    Need something custom? <Link href="/contact" class="underline underline-offset-4 hover:text-white">Get in touch</Link>.
                </p>
            </div>
        </section>
        ...
        <section id="faq" class="bg-[var(--color-cream)] py-24 sm:py-32">
            <div class="mx-auto max-w-3xl px-6 lg:px-8">
                <div class="text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">FAQ</p>
                    <h2 class="mt-3 font-serif text-4xl font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-5xl">
                ...
                <div class="mt-14 divide-y divide-[var(--color-sand-300)]/70 border-y border-[var(--color-sand-300)]/70">
                    <details v-for="faq in faqs" :key="faq.question" class="faq-item group py-6">
                        <summary class="-mx-2 flex cursor-pointer list-none items-start justify-between gap-6 rounded-xl px-2 py-1 transition duration-200 hover:bg-[var(--color-sand-200)]/30 focus-visible:bg-[var(--color-sand-200)]/40 focus-visible:ring-2 focus-visible:ring-[var(--color-emerald-600)]/40 focus-visible:outline-none">
                ...
                <p class="mt-10 text-center text-sm text-slate-600">
                    ...
                    <Link href="/contact" class="inline-flex items-center gap-1 font-semibold text-[var(--color-emerald-700)] underline-offset-4 hover:text-[var(--color-emerald-800)] hover:underline focus-visible:rounded focus-visible:ring-2 focus-visible:ring-[var(--color-emerald-600)]/50 focus-visible:outline-none">
                        Talk to us
                        <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M3 10a.75.75 0 01.75-.75h10.638L10.23 5.29a.75.75 0 111.04-1.08l5.5 5.25a.75.75 0 010 1.08l-5.5 5.25a.75.75 0 11-1.04-1.08l4.158-3.96H3.75A.75.75 0 013 10z" clip-rule="evenodd" />
                        </svg>
        ...
        <section class="relative isolate overflow-hidden bg-[var(--color-emerald-900)] py-24 text-white sm:py-32">
            ...
            <div class="mx-auto max-w-3xl px-6 text-center lg:px-8">
                <h2 class="font-serif text-4xl font-bold tracking-tight uppercase sm:text-5xl">
