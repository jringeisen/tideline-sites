...
const phoneHref = computed(() => `tel:${(company.value.phone ?? '').replace(/-/g, '')}`);
...
function submit(): void {
    form.post(store.url(), {
        preserveScroll: true,
        onSuccess: () => form.reset('name', 'email', 'phone', 'plan', 'is_veteran', 'message'),
    });
}
</script>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid gap-12 lg:grid-cols-12">
                    ...
                    <div class="lg:col-span-7">
                        ...
                        >
                            <CheckCircle2 class="mt-0.5 h-5 w-5 flex-none text-[var(--color-red)]" aria-hidden="true" />
                            <p>{{ status }}</p>
                        </div>
                            ...
                            <div class="grid gap-5 sm:grid-cols-2">
                                <div class="sm:col-span-2">
                                    ...
                                    <input
                                        ...
                                        required
                                        autocomplete="name"
                                        class="mt-1.5 block w-full rounded-xl border-0 bg-[var(--color-sand-50)] px-4 py-2.5 text-base text-[var(--color-ink)] shadow-sm ring-1 ring-inset focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[var(--color-emerald-600)] dark:focus:bg-white/[0.06]"
                                        :class="form.errors.name ? 'ring-red-400' : 'ring-[var(--color-sand-300)]'"
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        autocomplete="email"
                                        class="mt-1.5 block w-full rounded-xl border-0 bg-[var(--color-sand-50)] px-4 py-2.5 text-base text-[var(--color-ink)] shadow-sm ring-1 ring-inset focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[var(--color-emerald-600)] dark:focus:bg-white/[0.06]"
                                        :class="form.errors.email ? 'ring-red-400' : 'ring-[var(--color-sand-300)]'"
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        autocomplete="tel"
                                        class="mt-1.5 block w-full rounded-xl border-0 bg-[var(--color-sand-50)] px-4 py-2.5 text-base text-[var(--color-ink)] shadow-sm ring-1 ring-inset focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[var(--color-emerald-600)] dark:focus:bg-white/[0.06]"
                                        :class="form.errors.phone ? 'ring-red-400' : 'ring-[var(--color-sand-300)]'"
                                    />
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="relative mt-1.5">
                                        <select
                                            ...
                                            v-model="form.plan"
                                            name="plan"
                                            class="block w-full appearance-none rounded-xl border-0 bg-[var(--color-sand-50)] px-4 py-2.5 pr-10 text-base text-[var(--color-ink)] shadow-sm ring-1 ring-inset focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[var(--color-emerald-600)] dark:focus:bg-white/[0.06]"
                                            :class="form.errors.plan ? 'ring-red-400' : 'ring-[var(--color-sand-300)]'"
                                        >
                                            <option value="">— Select a plan —</option>
                                            <option value="essential">Essential — $299/mo (Web Design + SEO)</option>
                                            <option value="growth">Growth — $499/mo (Web Design + SEO + Blogs + Newsletters)</option>
                                            <option value="unsure">Not sure yet, help me decide</option>
                                        </select>
                                        <svg class="pointer-events-none absolute top-1/2 right-3 h-4 w-4 -translate-y-1/2 text-slate-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.06l3.71-3.83a.75.75 0 111.08 1.04l-4.25 4.39a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                                        </svg>
                                    </div>
                                    <p v-if="form.errors.plan" class="mt-1.5 text-sm text-red-600">{{ form.errors.plan }}</p>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <p v-if="form.errors.is_veteran" class="mt-1.5 text-sm text-red-600">{{ form.errors.is_veteran }}</p>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        required
                                        class="mt-1.5 block w-full rounded-xl border-0 bg-[var(--color-sand-50)] px-4 py-2.5 text-base text-[var(--color-ink)] shadow-sm ring-1 ring-inset focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[var(--color-emerald-600)] dark:focus:bg-white/[0.06]"
                                        :class="form.errors.message ? 'ring-red-400' : 'ring-[var(--color-sand-300)]'"
                            ...
                            <dl class="mt-8 space-y-6 text-sm">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <dd class="mt-0.5">
                                            <a :href="phoneHref" class="font-medium text-white hover:underline">{{ company.phoneDisplay }}</a>
                                        </dd>
                                    </div>
                                </div>
