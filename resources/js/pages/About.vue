    ...
    <div>
        ...
        <section class="bg-[var(--color-cream)] py-20 sm:py-28">
            <div class="mx-auto max-w-3xl px-6 lg:px-8">
                <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">Our story</p>
                    ...
                    <div class="space-y-8 lg:col-span-6">
                        <article>
                            <div class="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                                ...
                                <span class="text-sm font-medium tracking-wider text-[var(--color-red)] uppercase">Co-founder &amp; Lead Developer</span>
                            </div>
                        ...
                        <article>
                            <div class="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                                ...
                                <span class="text-sm font-medium tracking-wider text-[var(--color-red)] uppercase">Co-founder, Marketing &amp; Sales</span>
                            </div>
                            <p class="mt-3 text-base leading-relaxed text-slate-700">
        ...
        <section class="bg-[var(--color-cream)] py-20 sm:py-28">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <p class="text-xs font-semibold tracking-[0.18em] text-[var(--color-red)] uppercase">What we stand for</p>
                    <h2 class="mt-3 font-serif text-3xl font-bold tracking-tight text-[var(--color-deep-teal)] uppercase sm:text-4xl">
                ...
                <div class="mx-auto mt-14 grid max-w-5xl gap-6 sm:grid-cols-3">
                    ...
                    >
                        ...
                        <h3 class="mt-5 font-serif text-xl text-[var(--color-deep-teal)]">{{ value.title }}</h3>
                        <p class="mt-3 text-sm leading-relaxed text-slate-600">{{ value.copy }}</p>
                    </article>
                </div>
            </div>
        </section>
        ...
        <section class="relative isolate overflow-hidden bg-[var(--color-navy-deep)] py-20 text-white sm:py-28">
            ...
            <div class="mx-auto max-w-3xl px-6 text-center lg:px-8">
                <h2 class="font-serif text-3xl font-bold tracking-tight uppercase sm:text-4xl">
