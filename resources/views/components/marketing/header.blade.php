<header class="absolute inset-x-0 top-0 z-30">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
        <a href="{{ route('home') }}" class="flex items-center text-white" aria-label="All American Web Design home">
            <img src="{{ asset('logo-dark.png') }}" alt="All American Web Design" class="h-10 w-auto">
        </a>
