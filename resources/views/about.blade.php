...
<x-layouts.marketing
    ...
    <section class="bg-[var(--color-cream)] py-20 sm:py-28">
        <div class="mx-auto max-w-3xl px-6 lg:px-8">
            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--color-red)]">Our story</p>
    ...
    <section class="bg-[var(--color-cream)] py-20 sm:py-28">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--color-red)]">What we stand for</p>
            ...
            <div class="mx-auto mt-14 grid max-w-5xl gap-6 sm:grid-cols-3">
                @foreach ([
                    ...
                    <article class="rounded-2xl bg-white p-7 ring-1 ring-[var(--color-sand-300)]/60 dark:bg-white/[0.04] dark:ring-white/10">
                        ...
                        <h3 class="mt-5 font-serif text-xl text-[var(--color-deep-teal)]">{{ $title }}</h3>
